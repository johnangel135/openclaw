...
module.exports = {
  ...
  REDIS_CONNECT_TIMEOUT_MS: toBoundedInt(process.env.REDIS_CONNECT_TIMEOUT_MS, 3000, 500, 30000),
  REDIS_KEY_PREFIX: process.env.REDIS_KEY_PREFIX || 'openclaw:',
  ...
  STRIPE_METER_EVENT_INPUT_NAME: process.env.STRIPE_METER_EVENT_INPUT_NAME || 'managed_input_tokens',
  STRIPE_METER_EVENT_OUTPUT_NAME: process.env.STRIPE_METER_EVENT_OUTPUT_NAME || 'managed_output_tokens',
  DATA_PLANE_SHARED_TOKEN: process.env.DATA_PLANE_SHARED_TOKEN || '',
};
